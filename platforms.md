...
- **Язык программирования**: ArkTS, JavaScript, C++
...
| **Разработка**         | Java, Kotlin               | Swift, Objective-C            | ArkTS, JavaScript, C++       | C, C++                     |
...
7. **Kotlin Multiplatform**: Фреймворк для кроссплатформенной разработки на Kotlin, хорош когда есть готовая кодовая база на Android
